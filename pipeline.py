...
LUA_SHA1 = get_hash(os.path.join(CWD, 'heroku.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'site':
                site = item_value + '.herokuapp.com'
                wget_args.extend(['--warc-header', 'herokuapp-name: '+item_value])
                wget_args.extend(['--warc-header', 'herokuapp-site: '+site])
                wget_args.append('https://' + site + '/')
            else:
...
project = Project(
    title='Heroku',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/b/b7/Heroku-icon.png" height="50px" title=""/>
        <h2>herokuapp.com <span class="links"><a href="https://herokuapp.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/heroku/">Leaderboard</a></span></h2>
        <p>Archiving Heroku apps.</p>
    '''
)
